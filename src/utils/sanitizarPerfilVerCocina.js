...
const PERFIL_VER_COCINA_KEYS = new Set([
    ...
    'orientacionSplit',
    'mostrarTituloParticionTipo', 'tituloParticionTipo', 'tituloParticionNormal',
    'tituloParticionGuarnicion', 'tituloParticionGuarnicionNormal',
    'alinearTituloParticionTipo', 'colorTituloParticionTipo', 'colorTituloParticionNormal',
    'tamanioTituloParticionTipo', 'pesoTituloParticionTipo', 'fuenteFamiliaTituloParticionTipo',
    'mayusculasTituloParticionTipo', 'espaciadoLetraTituloParticionTipo',
    'colorFondoTituloParticionTipo', 'grosorSeparadorParticionTipo',
    'colorSeparadorParticionTipo', 'colorFondoParticionTipo',
]);
...
const PERFIL_TABLAS_KDS_KEYS = new Set([
    ...
    'ocultarCuadroCocineroAsignado',
    'usarPronombreCocineroKds',
    'cocineroNombreColor',
    'cocineroNombreFondo',
    'ocultarComplementosEnTablaKds',
    'paraLlevarTamano',
    ...
    'mozoNombreFondo',
    'headerTarjetaEstilo',
    'headerTarjetaOcultarPrep',
    'headerTarjetaFuente',
    'headerTarjetaTamano',
    'headerOcultarNumeroComanda',
    'headerTamanoNumeroComanda',
    'headerOcultarMesa',
    'headerTamanoMesa',
    'headerOcultarMozo',
    'headerTamanoMozo',
    'headerOcultarCronometro',
    'headerTamanoCronometro',
    'headerTarjetaColor',
