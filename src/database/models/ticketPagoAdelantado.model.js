...
ticketPagoAdelantadoSchema.index({ 'verificacionCierre.incluidoEnCierre': 1, createdAt: -1 });
ticketPagoAdelantadoSchema.index({ 'verificacionCierre.confirmado': 1, createdAt: -1 });
